...
<!-- sidebars -->
<main>
  <div class="d-flex flex-column flex-shrink-0 p-3 text-black" style="width: 280px; background-color:#FFB703;" id="ilang">
      <span class="fs-4" id="ilang">HALO, ADMIN!</span>
    
    <hr>
    <ul class="nav nav-pills flex-column mb-auto"  id="ilang">
      <li class="nav-item">
      ...
      <li>
        <a href="print.php" class="nav-link text-black">
          <svg class="bi me-2" width="16" height="16"><use xlink:href="#grid"/></svg>
          print
        </a>
      </li>
    ...
    <div class="b-example-divider" id="ilang"></div>
      <!-- body -->
<div class="container">
