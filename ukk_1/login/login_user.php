    ...
    <div class="row">
        ...
        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
              ...
              <div class="carousel-caption d-none d-md-block">
                <h5>registrasi</h5>
                <a href="../registrasi/registrasi.php">jika tidak memiliki akun,klik disini</a>
              </div>
            </div>
          </div>
      ...
      <div class="col">
        ...
        <div class="shadow-lg p-3 mb-5 bg-body bulat" style="margin-top: 50px;">
          ...
          <form style="text-align: center;" action="proses_login_user.php" method="post">
          <h1 style=" color: black;">login dulu ya!</h1> <br> <br>
            ...
            <a href="../registrasi/registrasi.php" style="text-align: center;">belum punya akun? klik disini</a>
            </form>
          </div>
        </div>
      </div>
